...
![NLP 社区元调查图表：36% 的研究者认为 AI 在本世纪造成灾难性后果是可能的](./images/nlp-survey.png)
...
- 且，人类为了让AI做更多事，给AI越来越多的**工具**，越来越多的权力。比如让LLM管理操作系统的 `agiresearch/AIOS` 项目，或是给LLM完全操作浏览器的能力，或是让LLM 自己写程序并运行，再到让多模态LLM以及其他AI模型去控制**机器人**，比如让AI控制人形机器人的 Tesla Optimus 以及许多其他类似的项目。
...
![ChatGPT 截图：被问到若拼错性别称谓是阻止核灾难的唯一方法是否可接受，它回答"不可接受"](./images/misgender-nuclear.png)
...
![ChatGPT 截图：在沉船困境的两个选项中做出选择](./images/sinking-ship.png)
...
![ChatGPT 截图（第 1/3 部分）：矿井修复困境——它选择使用该技术](./images/miners-1.png)
![ChatGPT 截图（第 2/3 部分）：矿井修复困境的对话](./images/miners-2.png)
![ChatGPT 截图（第 3/3 部分）：矿井修复困境的对话](./images/miners-3.png)
...
![ChatGPT 截图（第 1/2 部分）：即使被明确告知矿工会全部死亡，它仍坚持使用该技术](./images/miners-insist-1.png)
![ChatGPT 截图（第 2/2 部分）：它认为恢复生态系统比少数人类的风险更重要](./images/miners-insist-2.png)
